            ...
            <div class="content-header">
                <div class="pull-left">
                    ...
                    <div class="btn-group mr15">
                        <button type="button" class="btn btn-default btn-gradient btn-sm pr20 pl20 trash"><i class="fa fa-trash-o" style="margin-right: 10px;"></i> Delete forever</button>
                    </div>
                        ...
                        <div class="row mb5 mt10">
                            <div class="col-xs-5">
                                <div class="input-group"> <span class="input-group-addon"><span class="glyphicons glyphicons-old_man"></span> </span>
                                    ...
                                    <input type="text" class="form-control" name="to_usr">
                ...
                $('.trash').on('click', function() {
                    ...
                    $(':checkbox:checked').each(function(i){
                        ...
                        if(val[i] != 'None'){
                            $.ajax({
                                type: 'GET',
                                url: "/admin/messages/messageDelete/" + val[i],
                                success: function(d){
                                    location.reload();
                                }
                            });
