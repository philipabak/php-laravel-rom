            ...
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active">
                        <a href="{{ URL::route('admin.news.addNews') }}">Add New News</a>
                    </li>
                    <li class="crumb-icon">
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title"> <span class="glyphicons glyphicons-notes"></span> Add New News </span>
                        </div>
                        <div class="panel-body">
                        <form action="{{ URL::route('admin.news.addNewNews') }}" class="form-horizontal" id="admin_addAdminAddForm" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
                            ...
                            <fieldset class="fieldset">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input name="title" class="form-control" placeholder="Type the title" maxlength="200" type="text" id="NewsListTitle" required="required">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input name="slug" readonly="readonly" class="form-control" placeholder="Slug.." maxlength="200" type="text" id="NewsListSlug" required="required">
                                    </div>
                                </div>
                                <div class="form-group">
