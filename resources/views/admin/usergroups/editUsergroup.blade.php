    ...
    @section('content')
            ...
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active">
                        <a href="{{ URL::route('admin.usergroups.edit', $userItem->id) }}">Edit Usergroup</a>
                    <li class="crumb-icon">
                    ...
                    <li class="crumb-trail">Edit Usergroup</li>
                </ol>
            </div>
        </div>
        ...
        <div id="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span class="glyphicons glyphicons-pencil"></span> Edit Usergroup </span> </div>
                        <div class="panel-body">
                        <form action="{{ URL::route('admin.usergroups.update', $userItem->id) }}" name="User" class="form-horizontal" id="UserAdminAddForm" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
                            <input type="hidden" name="_token" id="_token" value="{{ csrf_token() }}">
                            <fieldset class="fieldset">
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">User Group Name</label>
                                    <div class="col-lg-6">
                                        <input name="type" class="form-control" placeholder="Type Usergroup Name" required="required" maxlength="255" type="text" id="type" value="{{ $userItem->type }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6 selectC">
                                        <select name="status" style="margin-left: -4px;" class="multiselect1 form-control" placeholder="Select Status" id="status" required="required">
                                            <option value="1" {{ ($userItem->status == 1)? 'selected' : '' }}>Yes</option>
                                            <option value="0" {{ ($userItem->status == 0)? 'selected' : '' }}>No</option>
                                        </select>
                                    </div>
                                </div>
