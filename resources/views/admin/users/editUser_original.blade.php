                        ...
                        <form action="{{ URL::route('admin.users.update', $userItem->id) }}" name="User" class="form-horizontal" id="UserAdminAddForm" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
                            ...
                            <fieldset class="fieldset">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input name="first_name" class="form-control" placeholder="Type Your First Name" required="required" maxlength="255" type="text" id="UserFirstName" value="{{ $userItem->first_name }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Last Name</label>
                                    <div class="col-lg-6">
                                        <input name="last_name" class="form-control" placeholder="Type Your last Name" maxlength="30" type="text" id="UserLastName" required="required" value="{{ $userItem->last_name }}">
                                    </div>
                                </div>
                            </fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6 selectC">
                                        <select name="role" style="margin-left: -4px;" class="multiselect1 form-control" placeholder="Select The Role" id="UserRole" required="required">
                                            ...
                                            <option value="Customer" {{ ($userItem->role == 'Custom')? 'selected' : '' }}>Customer</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <fieldset class="fieldset">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea name="addres" class="form-control" rows="4" title="Please Type your Address" cols="30" id="UserAddres" required="required">{{ $userItem->addres }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputMobile" class="col-lg-2 control-label"> Your Mobile:</label>
                                    <div class="col-lg-6">
                                        <input name="mobile" class="form-control" placeholder="Type Your Mobile Number" maxlength="30" type="text" id="UserMobile" required="required" value="{{ $userItem->mobile }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputPhone" class="col-lg-2 control-label">Your Phone:</label>
                                    <div class="col-lg-6">
                                        <input name="phone" class="form-control" placeholder="Type Your Phone Number" maxlength="30" type="tel" id="UserPhone" value="{{ $userItem->phone }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6 selectC">
                                        <select name="gender" style="margin-left: -4px;" class="multiselect1 form-control" placeholder="Select your gender" id="UserGender" required="required">
                                            ...
                                            <option value="Female" {{ ($userItem->role == 'Female')? 'selected' : '' }}>Female</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-group"> <span class="input-group-addon"><i class="fa fa-calendar"></i> </span>
                                            <input name="DOB" class="form-control datepicker mtn" id="datepicker" maxlength="10" autocomplete="off" placeholder="11/11/1111" type="text" required="required" value="{{ $userItem->DOB }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input name="nationality" class="form-control" placeholder="Enter your nationality" maxlength="50" type="text" id="UserNationality" required="required" value="{{ $userItem->nationality }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input name="zip" class="form-control" placeholder="Type Your Zip Code" maxlength="20" type="text" id="UserZip" required="required" value="{{ $userItem->zip }}">
                                    </div>
                                </div>
                            </fieldset>
    ...
    @section('custom-script')
        <script type="text/javascript">
            jQuery(document).ready(function () {
                ...
                var countryId = '<?php echo $userItem->country; ?>';
                $('input[name="multiselect"][type="radio"][value=' + countryId + ']').click();
            });
