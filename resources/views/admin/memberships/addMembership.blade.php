    ...
    @section('content')
            ...
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active">
                        <a href="{{ URL::route('admin.memberships.addMembership') }}">Add New Membership</a>
                    <li class="crumb-icon">
                    ...
                    <li class="crumb-trail">Add New Membership</li>
                </ol>
            </div>
        </div>
        ...
        <div id="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span class="glyphicons glyphicons-user_add"></span> Add New Membership </span> </div>
                        <div class="panel-body">
                        <form action="{{ URL::route('admin.memberships.addNewMembership') }}" name="User" class="form-horizontal" id="UserAdminAddForm" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
                            <input type="hidden" name="_token" id="_token" value="{{ csrf_token() }}">
                            <fieldset class="fieldset">
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Membership Type</label>
                                    <div class="col-lg-6">
                                        <input name="PlanType" class="form-control" placeholder="Type Membership Name" required="required" maxlength="255" type="text" id="PlanType">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Price</label>
                                    <div class="col-lg-6">
                                        <input name="Price" class="form-control" placeholder="Type Price" maxlength="30" type="number" id="Price" required="required">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Plan Duration(Months)</label>
                                    <div class="col-lg-6">
                                        <input name="PlanDuration" class="form-control" placeholder="Type Plan Duration" maxlength="30" type="number" id="Planduration" required="required">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Connections UpTo</label>
                                    <div class="col-lg-6">
                                        <input name="ConnectionsUpTo" class="form-control" placeholder="Type Connections UpTo" maxlength="30" type="number" id="ConnectionsUpTo" required="required">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Downloading Limit ( If you want to set unlimited, please type 0 as value )</label>
                                    <div class="col-lg-6">
                                        <input name="DownloadingLimit" class="form-control" placeholder="Type Downloading Limit" maxlength="30" type="number" id="DownloadingLimit" required="required">
                                    </div>
                                </div>
                                <div class="form-group">
