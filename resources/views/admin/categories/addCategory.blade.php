            ...
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active">
                        <a href="{{ URL::route('admin.categories.addCategory') }}">Add New Category</a>
                    </li>
                    <li class="crumb-icon">
                    ...
                    <li class="crumb-trail">Add New Category</li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title"> <span class="glyphicons glyphicons-circle_plus"></span> Add New Category </span>
                        </div>
                        <div class="panel-body">
                        <form action="{{ URL::route('admin.categories.addNewCategory') }}" class="form-horizontal" id="CategoryAdminAddForm" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
                            <input type="hidden" name="_token" id="_token" value="{{ csrf_token() }}">
                            <div class="form-group">
                                <label class="col-md-2 text-right">Category Name</label>
                                <div class="col-md-10">
                                    <div class="input-group col-md-6">
                                        <input name="name" class="form-control" placeholder="Category Name" maxlength="255" type="text" id="CategoryName" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="input-group col-md-6">
                                        <input name="slug" class="form-control" placeholder="Category Slug" maxlength="255" type="text" id="CategorySlug" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
