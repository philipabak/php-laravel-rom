            ...
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active">
                        <a href="{{ URL::route('admin.pages.edit', $viewPage->id) }}">Edit Page</a>
                    </li>
                    <li class="crumb-icon">
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title"> <span class="glyphicons glyphicons-pencil"></span> Add New CMS Page </span>
                        </div>
                        <div class="panel-body">
                        <form action="{{ URL::route('admin.pages.update', $viewPage->id) }}" class="form-horizontal" id="addAdminAddForm" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
                            ...
                            <fieldset class="fieldset">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input name="title" class="form-control" placeholder="Type the title" maxlength="200" type="text" id="CmsPageTitle" required="required" value="{{ $viewPage->title }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Slug</label>
                                    <div class="col-lg-6">
                                        <input name="slug" readonly="readonly" class="form-control" placeholder="Slug.." maxlength="200" type="text" id="CmsPageSlug" required="required" value="{{ $viewPage->slug }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="panel">
                                            <div class="panel-body pn">
                                                <textarea name="content" id="editor1" class="editor1" rows="4" placeholder="Enter the page content." cols="30">{{ $viewPage->content }}</textarea>
                                            </div>
                                        </div>
                            ...
                            <fieldset class="fieldset">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input name="meta_title" class="form-control" placeholder="Enter the page Meta Title." maxlength="100" type="text" id="CmsPageMetaTitle" value="{{ $viewPage->metal_title }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Keywords:</label>
                                    <div class="col-lg-6">
                                        <input name="keywords" class="form-control" placeholder="Enter the page keywords." maxlength="200" type="text" id="CmsPageKeywords" value="{{ $viewPage->keywords }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Description:</label>
                                    <div class="col-lg-6">
                                        <textarea name="meta_description" rows="6" class="form-control" placeholder="Enter the Meta Ddescription of page." cols="30" id="CmsPageMetaDescription">{{ $viewPage->meta_description }}</textarea>
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="fieldset">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="checkbox" name="p_area" value="Footer" {{ ($viewPage->p_area)? 'checked' : '' }} id="CmsPagePArea">
                                    </div>
                                </div>
