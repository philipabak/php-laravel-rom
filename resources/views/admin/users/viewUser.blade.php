                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <table id="user" class="table table-bordered table-striped" style="clear: both">
                                ...
                                <?php if($userItem->user_type == 4){ ?>
                                <tr>
                                    <td>Points</td>
                                    <td>{{ $userItem->points }}</td>
                                </tr>
                                <?php } ?>
                                <?php if($userItem->user_type == 7){ ?>
                                <tr>
                                    <td>Premium Membership Type</td>
                                    <td>{{ $userItem->membership_role }}</td>
                                </tr>
                                <?php } ?>
                                <tr>
                                    <td>User Name</td>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 70%;">{{ $userItem->first_name }} {{ $userItem->last_name }}</td>
                                </tr>
                                <tr>
                                    <td>Email</td>
