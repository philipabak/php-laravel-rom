                        ...
                        <form action="{{ URL::route('admin.users.addNewUser') }}" name="User" class="form-horizontal" id="UserAdminAddForm" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
                            ...
                            <fieldset class="fieldset">
                                ...
                                <div class="form-group" id="div_points">
                                    ...
                                    <div class="col-lg-6 selectC">
                                        <input name="points" class="form-control" placeholder="Type the Points" maxlength="50" type="number" id="points" required="required" value="0">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6 selectC">
                                        <select name="membership_role" style="margin-left: -4px;" class="multiselect1 form-control" placeholder="Select The Membership Role" id="MembershipRole" required="required">
                                            @foreach($membershipType as $membership)
                                                <option value="{{ $membership->id }}">{{ $membership->PlanType }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input name="name" class="form-control" placeholder="Type Your Name" required="required" maxlength="255" type="text" id="UserFirstName">
                                    </div>
                                </div>
                                <div class="form-group">
