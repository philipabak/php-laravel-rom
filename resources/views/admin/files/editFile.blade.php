                        ...
                        <div class="panel-body">
                            <form action="{{ URL::route('admin.files.update', $romview->id) }}" class="form-horizontal" id="add_fileAdminAddFileForm" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea name="search_terms" class="form-control" rows="2" placeholder="Type the search terms" cols="30" id="SearchTerms" required="required">{{ $romview->search_terms }}</textarea>
                                    </div>
                                </div>
...
--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input name="release" class="form-control" placeholder="Type the release group" maxlength="100" type="text" value="{{ $romview->release }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Language:</label>
                                    <div class="col-lg-6">
                                        <input name="language" class="form-control" placeholder="Type the language" maxlength="100" type="text" value="{{ $romview->language }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Previous version</label>
                                    <div class="col-lg-6">
                                        <input name="version" class="form-control" placeholder="Type the previouse version" maxlength="100" type="text" value="{{ $romview->version }}">
                                    </div>
                                </div>
    ...
    @section('custom-script')
        <script type="text/javascript"file_url>
            jQuery(document).ready(function () {
                ...
                var regionId = '<?php echo $romview->region; ?>';
                $('#div_region input[name="multiselect"][type="radio"][value=' + regionId + ']').click();

                var statusId = '<?php echo $romview->status; ?>';
